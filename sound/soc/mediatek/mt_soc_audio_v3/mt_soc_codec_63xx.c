...
#define AW8736_MODE1 /*0.8w*/ \
do { \
	AudDrv_GPIO_EXTAMP_Select(1); \
	udelay(GAP); \
} while (0)
#define AW8736_MODE2 /*0.8w*/ \
do { \
    AudDrv_GPIO_EXTAMP_Select(1); \
    udelay(GAP); \
...
#define SUB_AW8736_MODE1 /*0.8w*/ \
do { \
	AudDrv_GPIO_EXTAMP2_Select(1); \
	udelay(GAP); \
} while (0)
#define SUB_AW8736_MODE2 /*0.8w*/ \
do { \
    AudDrv_GPIO_EXTAMP2_Select(1); \
    udelay(GAP); \
    AudDrv_GPIO_EXTAMP2_Select(0); \
    udelay(GAP); \
    AudDrv_GPIO_EXTAMP2_Select(1); \
} while (0)

#define SUB_AW8736_MODE3 /*0.8w*/ \
do { \
	AudDrv_GPIO_EXTAMP2_Select(1); \
	udelay(GAP); \
	AudDrv_GPIO_EXTAMP2_Select(0); \
...
static DEFINE_SPINLOCK(aw8736_lock);
#endif
...
#else
spin_lock_irqsave(&aw8736_lock, flags);

#ifdef __HCT_BOARD_CONFIG_H__
#ifdef __HCT_USING_EXTAMP_HP__
         #if __HCT_EXTAMP_HP_MODE__ ==1
               AW8736_MODE1;
               SUB_AW8736_MODE1;
         #elif __HCT_EXTAMP_HP_MODE__ ==2
              AW8736_MODE2;
              SUB_AW8736_MODE2;
         #elif __HCT_EXTAMP_HP_MODE__ ==3
              AW8736_MODE3;
             SUB_AW8736_MODE3;
        #elif __HCT_EXTAMP_HP_MODE__ ==4
              AW8736_MODE4;
              SUB_AW8736_MODE4;
         #else
             AW8736_MODE2;
         ...
         #endif
#else
    #error "__HCT_EXTAMP_HP_MODE__  not defined or error"
#endif
#else
		AW8736_MODE2;
		SUB_AW8736_MODE2;     
#endif
spin_unlock_irqrestore(&aw8736_lock, flags);
