 ...
 * By default, this compile option is disabled.
 */
#if defined(__HCT_MSG2238_UPDATE_FIRMWARE_SUPPORT__)
#if __HCT_MSG2238_UPDATE_FIRMWARE_SUPPORT__
 ...
 */
	...
	#endif
#elif defined(__HCT_MSG2238_TP_PROXIMITY_SUPPORT__)
	#if __HCT_MSG2238_TP_PROXIMITY_SUPPORT__
		#define CONFIG_ENABLE_PROXIMITY_DETECTION
	#endif
#endif
