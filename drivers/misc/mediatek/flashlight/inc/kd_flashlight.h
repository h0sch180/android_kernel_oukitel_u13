...
#endif
#ifndef __HCT_FLASHLIGHT_OCP8132_SUPPORT__
#define __HCT_FLASHLIGHT_OCP8132_SUPPORT__ 0
#endif

#ifndef __HCT_SUB_FLASHLIGHT_OCP8132_SUPPORT__
#define __HCT_SUB_FLASHLIGHT_OCP8132_SUPPORT__ 0 
#endif

#ifndef __HCT_SUB_FLASHLIGHT_SUPPORT__
  #define __HCT_SUB_FLASHLIGHT_SUPPORT__ 0
#endif
#ifndef __HCT_SUB_FLASHLIGHT_PWM_SUPPORT__
  #define __HCT_SUB_FLASHLIGHT_PWM_SUPPORT__ 0
#endif

#ifndef __HCT_SUB_FLASHLIGHT_AW3641_SUPPORT__
  #define __HCT_SUB_FLASHLIGHT_AW3641_SUPPORT__ 0
#endif

#ifndef __HCT_SUB_FLASHLIGHT_AW3141_SUPPORT__
  #define __HCT_SUB_FLASHLIGHT_AW3141_SUPPORT__ 0
#endif


#if __HCT_FLASHLIGHT_SGM3785_SUPPORT__||__HCT_FLASHLIGHT_AW3641_SUPPORT__||__HCT_FLASHLIGHT_AW3141_SUPPORT__||__HCT_FLASHLIGHT_OCP8132_SUPPORT__
    ...
    #error "FLASHLIGHT: SGM3785,AW3641, AW3141 ,ocp8132 can only defined one~~~~ "
  #else
  #endif
 #else
		 #if __HCT_FLASHLIGHT_AW3641_SUPPORT__
			 #if __HCT_FLASHLIGHT_AW3141_SUPPORT__||__HCT_FLASHLIGHT_OCP8132_SUPPORT__
			 #error "FLASHLIGHT: SGM3785,AW3641, AW3141 ,ocp8132 can only defined one~~~~ "
			 #else
			 #endif
		 #else
...
#if  __HCT_SUB_FLASHLIGHT_AW3141_SUPPORT__||__HCT_SUB_FLASHLIGHT_AW3641_SUPPORT__||__HCT_SUB_FLASHLIGHT_OCP8132_SUPPORT__
  #if !__HCT_SUB_FLASHLIGHT_SUPPORT__
      #error "FLASHLIGHT: __HCT_SUB_FLASHLIGHT_AW3641/_SUPPORT__  but __HCT_SUB_FLASHLIGHT_SUPPORT__ need defined first ~~~~ "
  #endif
#endif
...
#define FL_SUB_MODE_PIN    		4
#define FL_SUB_PMW_PIN					5
