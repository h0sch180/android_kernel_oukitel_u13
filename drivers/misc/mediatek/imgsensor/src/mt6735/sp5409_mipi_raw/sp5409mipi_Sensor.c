...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x8a162729,        //checksum value for Camera Auto Test
...
write_cmos_sensor(0x06,0x00); //vblank ԭΪ0x01\B8\C4Ϊ0x00 \BD\E2\BE\F6\BB\B5\CF\DF\CE\CA\CC\E2150831
...
write_cmos_sensor(0x10,0x00); //\C6ع\E2ʱ\BC\E4\B5\CD\D3\DA10ms\BD\F8\C8\EBoutdoor 
write_cmos_sensor(0x11,0xeb);
write_cmos_sensor(0x12,0x00); //\C6ع\E2ʱ\BC\E4\B8\DF\D3\DA10ms,\B5\CD\D3\DA110ms\BD\F8\C8\EBnormal̬
write_cmos_sensor(0x13,0xed);
write_cmos_sensor(0x14,0x0a); //\C6ع\E2ʱ\BC\E4\B8\DF\D3\DA110ms,\B5\CD\D3\DA160ms\A3\AC\D4\F6\D2\E6\B8\DF\D3\DA4x\BD\F8\C8\EBdummy
write_cmos_sensor(0x15,0x2f);
write_cmos_sensor(0x16,0x0e); //\C6ع\E2ʱ\BC\E4\B8\DF\D3\DA160ms,\D4\F6\D2\E6Ϊ6x\BD\F8\C8\EBlowlight
...
write_cmos_sensor(0x93,0x00); //\B9ر\D5gͨ\B5\C0ƽ\BB\AC
       }
}    /*    MIPI_sensor_Init  */
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    if(enable)
		...
		write_cmos_sensor(0xfd,0x01);
		write_cmos_sensor(0x0d,0x01);  //test_en
		write_cmos_sensor(0xfb,0x21);  //abl
		write_cmos_sensor(0x01,0x01);
    } else {
      	write_cmos_sensor(0xfd,0x00);
       	write_cmos_sensor(0x1b,0x00);
		write_cmos_sensor(0x1c,0x00);
		write_cmos_sensor(0xfd,0x01);
		write_cmos_sensor(0x0d,0x00);  //test_en
		write_cmos_sensor(0xfb,0x00);  //abl
		write_cmos_sensor(0x01,0x01);
    }
