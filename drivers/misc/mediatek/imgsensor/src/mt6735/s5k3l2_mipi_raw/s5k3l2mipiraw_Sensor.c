...
{
   kal_uint16 R_GAIN, B_GAIN,  G_GAIN, r_ratio, b_ratio, golden_r_ratio,golden_b_ratio,Base_gain;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
               printk("hsl 3l2 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
        ...
        read_s5k3l2_eeprom_mtk_fmt();
            ...
            printk("hsl 3l2 Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
