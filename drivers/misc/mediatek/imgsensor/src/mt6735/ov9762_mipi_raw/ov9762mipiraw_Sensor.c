...
static imgsensor_info_struct imgsensor_info = { 
    ...
    .sensor_clock_polarity =SENSOR_CLOCK_POLARITY_LOW,
    .sensor_hsync_polarity =SENSOR_CLOCK_POLARITY_LOW, // inverse with datasheet
    .sensor_vsync_polarity =SENSOR_CLOCK_POLARITY_LOW,
};
...
#if 0//def CONFIG_BSP_TW_ENHANCE
    /* initail sequence write in  */
    if ((cur_idx >0 || cur_idx == 0) && cur_pos != 0) {
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->SensorClockPolarity = imgsensor_info.sensor_clock_polarity;
    sensor_info->SensorClockFallingPolarity = SENSOR_CLOCK_POLARITY_LOW; /* not use */
    sensor_info->SensorHsyncPolarity = imgsensor_info.sensor_hsync_polarity; // inverse with datasheet
    sensor_info->SensorVsyncPolarity = imgsensor_info.sensor_vsync_polarity;
