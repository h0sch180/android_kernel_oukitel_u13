...
#if Hi841_OTP_FUNCTION //Hi-841 OPT
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
 ...
 { 3264, 2448,     0,    0, 3264, 2448,  3264, 2448, 0000, 0000, 1632, 1224,      0,    0, 1632, 1224}, // video
 { 2560, 1920,     352,  264, 640, 480, 640, 480,  0000, 0000, 640, 480,      0,    0, 640, 480,}, //hight speed video
 { 3264, 2448,     352,  504, 2560, 1440, 2560, 1440, 0000, 0000, 1280,  720,      0,    0, 1280,  720}
 };// slim video
...
void Hi841_Sensor_OTP_info(void)
{
  ...
  LOG_INF("%s enter\n",__func__);
   ...
   if (HI841_Sensor_OTP_read(0xbd00) == 0x01)
	   {info_flag = 1;}
   else if (HI841_Sensor_OTP_read(0xbd20) == 0x01)
	   {info_flag = 2;}
   else if (HI841_Sensor_OTP_read(0xbd40) == 0x01)
	   {info_flag = 3;}
  printk("%s,info_flag = 0x%x\n",__func__,info_flag);
    switch (info_flag)
  {
    case 0x01:  //Group1
    ModuleHouseID = HI841_Sensor_OTP_read(0xBD01);
   // CalibrationVersion=HI841_Sensor_OTP_read(0xBCEF);
    Year = HI841_Sensor_OTP_read(0xBD05);
    Month = HI841_Sensor_OTP_read(0xBD06);
    Day = HI841_Sensor_OTP_read(0xBD07);
    //SensorID = HI841_Sensor_OTP_read(0xBCF3);
    LensID = HI841_Sensor_OTP_read(0xBD02);
    VCMID = HI841_Sensor_OTP_read(0xBD03);
    DriverID = HI841_Sensor_OTP_read(0xBD04);
   ...
   // ColorTemperature = HI841_Sensor_OTP_read(0xBCF8);
    ...
    infocheck = HI841_Sensor_OTP_read(0xBD1F);
      break;
    case 0x13:
    ModuleHouseID = HI841_Sensor_OTP_read(0xBD21);
   // CalibrationVersion=HI841_Sensor_OTP_read(0xBD28);
    Year = HI841_Sensor_OTP_read(0xBD25);
    Month = HI841_Sensor_OTP_read(0xBD26);
    Day = HI841_Sensor_OTP_read(0xBD27);
    //SensorID = HI841_Sensor_OTP_read(0xBD2C);
    LensID = HI841_Sensor_OTP_read(0xBD22);
    VCMID = HI841_Sensor_OTP_read(0xBD23);
    DriverID = HI841_Sensor_OTP_read(0xBD24);
    ...
    infocheck = HI841_Sensor_OTP_read(0xBD3F);
    break;
    case 0x37:
    ModuleHouseID = HI841_Sensor_OTP_read(0xBD41);
    //CalibrationVersion=HI841_Sensor_OTP_read(0xBD61);
    Year = HI841_Sensor_OTP_read(0xBD45);
    Month = HI841_Sensor_OTP_read(0xBD46);
    Day = HI841_Sensor_OTP_read(0xBD47);
    //SensorID = HI841_Sensor_OTP_read(0xBD65);
    LensID = HI841_Sensor_OTP_read(0xBD42);
    VCMID = HI841_Sensor_OTP_read(0xBD43);
    DriverID = HI841_Sensor_OTP_read(0xBD44);
    ...
    infocheck = HI841_Sensor_OTP_read(0xBD5F);
    break;
    default:
...
void Hi841_Sensor_OTP_update_LSC(void)
{
  ...
  //lsc_flag = HI841_Sensor_OTP_read(0xBCED);
	if (HI841_Sensor_OTP_read(0xbce2) == 0x01)
		{lsc_flag = 1;}
	else if (HI841_Sensor_OTP_read(0xbce4) == 0x01)
		{lsc_flag = 2;}
	else if (HI841_Sensor_OTP_read(0xbce6) == 0x01)
		{lsc_flag = 3;}
...
kal_uint16 HI841_Sensor_calc_wbdata(void)
{
 ...
 //      g_gain = 0;
  ...
  if (HI841_Sensor_OTP_read(0xbd00) == 0x01)
    ...
    wb_unit_rg_h = HI841_Sensor_OTP_read(0xBD08);
    wb_unit_rg_l = HI841_Sensor_OTP_read(0xBD09);
    wb_unit_bg_h = HI841_Sensor_OTP_read(0xBD0A);
    wb_unit_bg_l = HI841_Sensor_OTP_read(0xBD0B);
    wb_unit_gg_h = HI841_Sensor_OTP_read(0xBD0C);
    wb_unit_gg_l = HI841_Sensor_OTP_read(0xBD0D);
    wb_golden_rg_h = HI841_Sensor_OTP_read(0xBD0E);
    wb_golden_rg_l = HI841_Sensor_OTP_read(0xBD0F);
    wb_golden_bg_h = HI841_Sensor_OTP_read(0xBD10);
    wb_golden_bg_l = HI841_Sensor_OTP_read(0xBD11);
    wb_golden_gg_h = HI841_Sensor_OTP_read(0xBD12);
    wb_golden_gg_l = HI841_Sensor_OTP_read(0xBD13);
    ...
    wbcheck = HI841_Sensor_OTP_read(0xBD1F);
      break;
	case 0x13:  //Group2 valid
    wb_unit_rg_h = HI841_Sensor_OTP_read(0xBD28);
    wb_unit_rg_l = HI841_Sensor_OTP_read(0xBD29);
    wb_unit_bg_h = HI841_Sensor_OTP_read(0xBD2A);
    wb_unit_bg_l = HI841_Sensor_OTP_read(0xBD2B);
    wb_unit_gg_h = HI841_Sensor_OTP_read(0xBD2C);
    wb_unit_gg_l = HI841_Sensor_OTP_read(0xBD2D);
    wb_golden_rg_h = HI841_Sensor_OTP_read(0xBD2E);
    wb_golden_rg_l = HI841_Sensor_OTP_read(0xBD2F);
    wb_golden_bg_h = HI841_Sensor_OTP_read(0xBD30);
    wb_golden_bg_l = HI841_Sensor_OTP_read(0xBD31);
    wb_golden_gg_h = HI841_Sensor_OTP_read(0xBD32);
    wb_golden_gg_l = HI841_Sensor_OTP_read(0xBD33);
    ...
    wbcheck = HI841_Sensor_OTP_read(0xBD3F);
    break;
		 case 0x37:  //Group3 valid
    wb_unit_rg_h = HI841_Sensor_OTP_read(0xBD48);
    wb_unit_rg_l = HI841_Sensor_OTP_read(0xBD49);
    wb_unit_bg_h = HI841_Sensor_OTP_read(0xBD4A);
    wb_unit_bg_l = HI841_Sensor_OTP_read(0xBD4B);
    wb_unit_gg_h = HI841_Sensor_OTP_read(0xBD4C);
    wb_unit_gg_l = HI841_Sensor_OTP_read(0xBD4D);
    wb_golden_rg_h = HI841_Sensor_OTP_read(0xBD4E);
    wb_golden_rg_l = HI841_Sensor_OTP_read(0xBD4F);
    wb_golden_bg_h = HI841_Sensor_OTP_read(0xBD50);
    wb_golden_bg_l = HI841_Sensor_OTP_read(0xBD51);
    wb_golden_gg_h = HI841_Sensor_OTP_read(0xBD52);
    wb_golden_gg_l = HI841_Sensor_OTP_read(0xBD53);
    ...
    wbcheck = HI841_Sensor_OTP_read(0xBD5F);
    break;
    default:
...
//  wb_golden_bg_l = 0x09;//
  ...
  rg_golden_value = 0x015a; //((wb_golden_rg_h << 8)|wb_golden_rg_l);
  bg_golden_value = 0x0118; //((wb_golden_bg_h << 8)|wb_golden_bg_l);
...
// AG = 256/(B[7:0] + 32)
	// hi841\90|\BCČ\E0\B8\F48ε\8E\D8ͤgain,(7 * 255 / 256)ε\B7\BD\E2\E2gain
	if(gain > 4080)  
	{
		gain= 4080;
	}
	if(gain < 58)  // gain\D7hreg\90|\BC\C4\D6\C5\ED\93255
	{
		gain = 58;
	}
	...
	else
	{
		...
		write_cmos_sensor(0x0205, 0);   // 8ε\8E\D8ͤgain
...
write_cmos_sensor(0x6000, 0x02);//01 Roy 
write_cmos_sensor(0x0100, 0x00);
write_cmos_sensor(0x0100, 0x00);
write_cmos_sensor(0x0100, 0x00);
write_cmos_sensor(0x0100, 0x00);
...
write_cmos_sensor(0x0307, 0x5c); //5F); 
...
// MIPI Setting 
write_cmos_sensor(0x0800, 0x55); 
write_cmos_sensor(0x0801, 0x1a); 
write_cmos_sensor(0x0802, 0x20); 
write_cmos_sensor(0x0803, 0x27);
write_cmos_sensor(0x0804, 0x2a); 
write_cmos_sensor(0x0805, 0x1e); 
write_cmos_sensor(0x0806, 0x5d); 
write_cmos_sensor(0x0807, 0x1d); 
...
write_cmos_sensor(0x5c05, 0xa0);  //    add for OTP GRID                                          
write_cmos_sensor(0x5c07, 0xd6);  //   add for OTP GRID   
...
write_cmos_sensor(0x5c05, 0x50);  //    add for OTP GRID                                          
write_cmos_sensor(0x5c07, 0x6D);  //   add for OTP GRID   
			...
			do {
				*sensor_id = ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001));
				if (*sensor_id == imgsensor_info.sensor_id) {				
					printk("yangbo==hi841_i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
					return ERROR_NONE;
				}	
