...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI259_SENSOR_ID, //HI259MIPI_SENSOR_ID,  /*sensor_id = 0x2680*/ //record sensor id defined in Kd_imgsensor.h
...
{{ 1632, 1228,    16,  16, 1600, 1200, 1600, 1200, 0, 0, 1600, 1200,	  0,	0, 1600, 1200}, // Preview 
 { 1632, 1228,    16,  16, 1600, 1200, 1600, 1200, 0, 0, 1600, 1200,	  0,	0, 1600, 1200}, // capture 
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	kal_uint16 reg_gain = 0xe000;
        ...
        //reg_gain =  (uint16_t)((512/gain)-(292/10)); 
          reg_gain =  (uint16_t)((256/gain)-(146/10)); 
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	*/
	...
	write_cmos_sensor(0x60, reg_gain<<8);
...
//////////////////
 ...
 write_cmos_sensor(0x21	,0x10);		//20150127
 write_cmos_sensor(0x22	,0x00);		//20150127
 write_cmos_sensor(0x23	,0x10);		//20150127
 write_cmos_sensor(0x24	,0x00);		//20150127
 write_cmos_sensor(0x25	,0x0c);		//20150127
 write_cmos_sensor(0x26	,0x00);		//20150127
 write_cmos_sensor(0x27	,0x10);		//20150127
 ...
 write_cmos_sensor(0x4e	,0x05); // 30fps set
...
//////////////////
 ...
 write_cmos_sensor(0x12	,0x40); //2014.10.23.a //2014.08.25.a
 write_cmos_sensor(0x13	,0x00);
 write_cmos_sensor(0x16	,0x00);
...
//////////////////
 ...
 write_cmos_sensor(0x80	,0x70);
 write_cmos_sensor(0x81	,0x00);
 write_cmos_sensor(0x82	,0x30);
 write_cmos_sensor(0x83	,0x00);
...
// DATA Lane Timing Control //
 ...
 write_cmos_sensor(0x31, 0xd0);  // l_pkt_wc_l   1600 * 5 / 4 = 2000  (MIPI Data Byte)
