...
write_cmos_sensor(0x0032, 0x1111);                                   
//write_cmos_sensor(0x0006, 0x09c8);   
write_cmos_sensor(0x0006, 0x13b8); //5408 for PIP               
write_cmos_sensor(0x0a22, 0x0000);
//write_cmos_sensor(0x0a12, 0x0c80);
//write_cmos_sensor(0x0a14, 0x0960);
write_cmos_sensor(0x0a12, 0x0cc0);//x output size 
...
write_cmos_sensor(0x002a, 0x013f);                                                
write_cmos_sensor(0x0026, 0x0150);                                                                                                                     
write_cmos_sensor(0x002c, 0x08cf);                  
write_cmos_sensor(0x005c, 0x0410);                  
...
write_cmos_sensor(0x0a04, 0x0162);  
...
write_cmos_sensor(0x091e, 0x0a00);                  
write_cmos_sensor(0x090c, 0x0593);                  
write_cmos_sensor(0x090e, 0x003b);                                                              
...
write_cmos_sensor(0x002a, 0x0237);       
