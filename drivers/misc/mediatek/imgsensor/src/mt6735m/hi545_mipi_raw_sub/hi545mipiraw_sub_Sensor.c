...
#include "hi545mipiraw_sub_Sensor.h"

extern void kdSetI2CSpeed(u32 i2cSpeed);  

/****************************Modify Following Strings for Debug****************************/
#define DEBUG_TAG   "[V28]"
#define PFX "[HI545SUB]"DEBUG_TAG
#define LOG_1 LOG_INF("HI545SUB,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = HI545MIPI_SUB_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
{
    kal_uint32 sensorid = (read_cmos_sensor(0x0F17) << 8) | read_cmos_sensor(0x0F16);
    LOG_INF("arthurwang return_sensor_id id: 0x%x, id: 0x%x\n", sensorid, pinSetIdx);
    return  (sensorid + 1);
}
