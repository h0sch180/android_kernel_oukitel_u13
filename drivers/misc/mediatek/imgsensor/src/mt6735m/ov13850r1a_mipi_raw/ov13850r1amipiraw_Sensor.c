...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .mipi_data_lp2hs_settle_dc = 65,//100,//unit , ns
        /*     following for GetDefaultFramerateByScenario()    */
        .max_framerate = 300,
    },
    .cap = {
        .pclk = 448000000,//448000000,//,480000000 //neil 20150113 reg
        .linelength = 4800,//4800,//neil 20150113 add water
        .framelength = 3328,//add fps
        .startx = 0,
        .starty = 0,
        .grabwindow_width = 4192, //4192, sensor out width
        .grabwindow_height = 3104,//3104, sensor out height
        .mipi_data_lp2hs_settle_dc = 65,//100,//unit , ns
        .max_framerate = 280,//280,//268,300 150 for test 0615 
...
if (capture_first_flag_r1a == 0)
{
    ...
    if (currefps == 150) { //15fps for PIP
        //@@full_132PCLK_24.75
			...
			write_cmos_sensor(0x0302, 0x32);// 0x29 for 984Mbps, 0x32 for 1.2Gbps
			write_cmos_sensor(0x0303, 0x00);//
			write_cmos_sensor(0x3612, 0x08);// 0x09 for 100.8Mhz sysclk,0x08 for 112Mhz sysclk
	        write_cmos_sensor(0x3614, 0x2a);//2d neil add 20150113
			write_cmos_sensor(0x3501, 0xc0);//   
			write_cmos_sensor(0x3702, 0x40);// ;add for VGA differences
			write_cmos_sensor(0x370a, 0x24);//
