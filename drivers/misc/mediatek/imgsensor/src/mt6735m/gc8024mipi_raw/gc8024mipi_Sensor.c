...
#define LOG_1 LOG_INF("GC8024,MIPI 4LANE\n")
/****************************   Modify end    *******************************************/
...
#define MIRROR 		  0xd4
#define CROP_STARTY	  0x03
#define CROP_STARTX     0x05
#endif

#ifdef IMAGE_H_MIRROR
#define MIRROR 		  0xd5
#define CROP_STARTY	  0x03
#define CROP_STARTX     0x02
#endif

#ifdef IMAGE_V_MIRROR
#define MIRROR 		  0xd6
#define CROP_STARTY     0x04
#define CROP_STARTX     0x05
#endif

#ifdef IMAGE_HV_MIRROR
#define MIRROR  	  0xd7
#define CROP_STARTY	  0x02
#define CROP_STARTX     0x02
#endif
...
#define ANALOG_GAIN_8 696  // 10.87x
#define ANALOG_GAIN_9 981  // 15.32x
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        .pclk = 270000000,                //record different mode's pclk
        .linelength = 7200,                //record different mode's linelength
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x19, 0x0c);//9d
	...
	write_cmos_sensor(0x92, CROP_STARTY); //crop y
	write_cmos_sensor(0x94, CROP_STARTX); //crop x
