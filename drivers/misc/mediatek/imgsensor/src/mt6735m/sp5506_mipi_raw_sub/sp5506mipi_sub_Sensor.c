...
#include "sp5506mipi_sub_Sensor.h"

#define PFX "sp5506_sub_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = SP5506MIPI_SUB_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
{
	LOG_INF("SP5506_SUB_Sensor_Init_2lane E\n");
	//SP5506R1A_AM01d 
...
{
  #if 0
	LOG_INF("SP5506 SUB CaptureSetting_2lane enter! currefps:%d\n",currefps);
