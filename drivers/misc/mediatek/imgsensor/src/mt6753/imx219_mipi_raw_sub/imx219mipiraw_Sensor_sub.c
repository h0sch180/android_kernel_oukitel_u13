...
#include "imx219mipiraw_Sensor_sub.h"

#ifdef CONFIG_MTK_CAM_CAL
extern int read_imx219_eeprom_mtk_fmt_sub(void);
#endif


/****************************Modify following Strings for debug****************************/
#define PFX "imx219_camera_sensor_sub"
#define LOG_1 LOG_INF("imx219_sub,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX219_SENSOR_SUB_ID,		//record sensor id defined in Kd_imgsensor.h
