...
static void capture_setting(kal_uint16 currefps)
{
  ...
  write_cmos_sensor(0x380f, (imgsensor_info.cap.framelength & 0xFF));         // vts
	...
	write_cmos_sensor(0x3821,0x06); //0x01
	write_cmos_sensor(0x3820,0x00); //0x47     
...
static void video_720p_setting(void)
{
    ...
    write_cmos_sensor(0x380f, (imgsensor_info.slim_video.framelength & 0xFF));   
	  ...
	  write_cmos_sensor(0x3800,0x00);
	  write_cmos_sensor(0x3801,0x18);
	  write_cmos_sensor(0x3802,0x00);
	  write_cmos_sensor(0x3803,0xf8);	
	  write_cmos_sensor(0x3804,0x0a);
	  write_cmos_sensor(0x3805,0x27);
	  write_cmos_sensor(0x3806,0x06);
	  write_cmos_sensor(0x3807,0xa7);
	  
	  write_cmos_sensor(0x3a08,0x01);
	  write_cmos_sensor(0x3a09,0xbe);	
	  write_cmos_sensor(0x3a0a,0x01);
	  write_cmos_sensor(0x3a0b,0x74);
	  write_cmos_sensor(0x3a0d,0x02);
	  write_cmos_sensor(0x3a0e,0x01);
	  write_cmos_sensor(0x4004,0x02);
	  write_cmos_sensor(0x4837,0x32);
	  write_cmos_sensor(0x0100,0x01);
