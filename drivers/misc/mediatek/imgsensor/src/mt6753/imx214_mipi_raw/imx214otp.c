...
//static kal_uint16 lscotpdata[LSCOTPDATASIZE];
...
//go to page
#if 1
static kal_uint16 IMX214_GotoPage(kal_uint16 page)
{
  return 1;
}


static kal_uint16 check_IMX214_otp_valid_AFPage(void)
{	

    kal_uint16 AF_OK = 0x00;
	u8 readbuff;//, i;
...
static kal_uint16 check_IMX214_otp_valid_AWBPage(void)
{
	kal_uint16 AWB_OK = 0x00;
	u8 readbuff;//, i;
...
kal_bool check_IMX214_otp_valid_LSC_Page(kal_uint16 page)
{
	kal_uint16 LSC_OK = 0x00;
	u8 readbuff;//, i;
...
#if 1
 kal_bool IMX214_Read_LSC_Otp(kal_uint16 pagestart,kal_uint16 pageend,u16 Outdatalen,unsigned char * pOutputdata)
 {
 ...
 void IMX214_ReadOtp(kal_uint16 page,kal_uint16 address,unsigned char *iBuffer,unsigned int buffersize)
{
		kal_uint16 i = 0;
...
{
   int  i4RetValue = 0;
    kal_uint16 page = 0, pageS=0,pageE=1;;
