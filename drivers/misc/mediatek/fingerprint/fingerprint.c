...
#else
  #error "Kconfig finger support opened , but custom_config finger is closed"
#endif
...
*hct_finger_int_as_int,*hct_finger_power_18v_on, *hct_finger_power_18v_off;
