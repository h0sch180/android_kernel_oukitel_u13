...
params->dsi.vertical_sync_active				= 2;
	...
	params->dsi.horizontal_backporch				= 104;
...
#if defined(BUILD_LK)
printf("%s, [rm68200_ctc50_jhzt]  buffer[0] = [0x%d] buffer[2] = [0x%d] ID = [0x%d]\n",__func__, buffer[0], buffer[1], id);
#else
printk("%s, [rm68200_ctc50_jhzt]  buffer[0] = [0x%d] buffer[2] = [0x%d] ID = [0x%d]\n",__func__, buffer[0], buffer[1], id);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_rm68200_dsi_vdo_hd_cmi_50_ykl = 
{
	.name			= "hct_rm68200_dsi_vdo_hd_cmi_50_ykl",
