...
//--- Sequence Ctrl  ----//
 {0x70 ,1,{0x10}},	//DC0 ,1,{DC1
 {0x71 ,1,{0x13}},	//DC2 ,1,{DC3
 {0x72 ,1,{0x06}},	//DC7
 {0x75 ,1,{0x03}},	//
...
//SET RGBCYC
 {0x37 ,1,{0x09}},	//SS=1 ,1,{ BGR=1  // {0x37 ,1,{0x09}},	//
 {0x38 ,1,{0x04}},	//column
...
//--- power voltage  ----//
 ...
 {0x5A ,1,{0x2A}},	//VGH  ,1,{15.4V
 {0x5B ,1,{0x1B}},	//VGL ,1,{-12.4V 
 {0x5C ,1,{0x16}},	// 
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_jd9365_dsi_vdo_hd_cpt_50_xq = 
{
	.name			= "hct_jd9365_dsi_vdo_hd_cpt_50_xq",
