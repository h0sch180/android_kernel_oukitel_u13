...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.PLL_CLOCK=247;//227;//254;//254//247
...
#ifdef BUILD_LK
    printf("%s,  hct_ili9881_dsi_vdo_hd_cmi_50_hlt id = 0x%x id_high = 0x%x id_low = 0x%x\n", __func__, id, id_high, id_low);
#else
    printk("%s,  hct_ili9881_dsi_vdo_hd_cmi_50_hlt id = 0x%x id_high = 0x%x id_low = 0x%x\n", __func__, id, id_high, id_low);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_ili9881_dsi_vdo_hd_cmi_50_hlt = 
{
    .name           = "hct_ili9881_dsi_vdo_hd_cmi_50_hlt",
